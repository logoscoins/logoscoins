...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("LogosCoins"));
    case mBTC: return QString(QObject::tr("Milli-LogosCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-LogosCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}

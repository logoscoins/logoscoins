...
{
    return GetBoolArg("-testnet", false) ? 18345 : 43244;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop LogosCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer(void* parg)
{
    ...
    RenameThread("LogosCoin-rpclist");
...
void ThreadRPCServer3(void* parg)
{
    ...
    RenameThread("LogosCoin-rpchand");
